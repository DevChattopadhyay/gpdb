...
//
//	@filename:
//		CXformDynamicGet2DynamicTableScanStatic.cpp
//
//	@doc:
...
//---------------------------------------------------------------------------
//	@function:
//		CXformDynamicGet2DynamicTableScanStatic::CXformDynamicGet2DynamicTableScanStatic
//
//	@doc:
//		Ctor
//
...
CXformDynamicGet2DynamicTableScanStatic::Exfp(CExpressionHandle &exprhdl) const
{
...
//---------------------------------------------------------------------------
//	@function:
//		CXformDynamicGet2DynamicTableScanStatic::Transform
//
//	@doc:
...
//---------------------------------------------------------------------------
void
CXformDynamicGet2DynamicTableScanStatic::Transform(CXformContext *pxfctxt,
												   CXformResult *pxfres,
												   CExpression *pexpr) const
{
	...
	CExpression *pexprAlt = GPOS_NEW(mp) CExpression(
		mp, GPOS_NEW(mp) CPhysicalDynamicTableScanStatic(
